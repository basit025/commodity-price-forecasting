...
# Cell 1
cells.append(nbf.v4.new_markdown_cell("""# Deep Learning Training (Neural Networks) - 120-Day Horizon
This notebook trains 5 neural architectures across 6 commodities for a **120-Day horizon**:
...
Includes dynamic 120-day target calculation, strictly enforced patience (20) for massive overlapping target noise, and live loss curves."""))
...
BATCH_SIZE = 32
EPOCHS = 150
PATIENCE = 20 # strictly enforced for 120-day overlapping noise
LR = 0.001
HIDDEN_SIZE = 32
...
nb.cells = cells
with open('DL_Training_120d.ipynb', 'w') as f:
    nbf.write(nb, f)
print("Created DL_Training_120d.ipynb for 120-Day Horizon")
