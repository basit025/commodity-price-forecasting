...
# Cell 1
cells.append(nbf.v4.new_markdown_cell("""# Deep Learning Training (Neural Networks) - 90-Day Horizon
This notebook trains 5 neural architectures across 6 commodities for a **90-Day horizon**:
...
Includes dynamic 90-day target calculation, strictly enforced patience (20) for massive overlapping target noise, and live loss curves."""))
...
BATCH_SIZE = 32
EPOCHS = 150
PATIENCE = 20 # strictly enforced for 90-day overlapping noise
LR = 0.001
HIDDEN_SIZE = 32
...
nb.cells = cells
with open('DL_Training_90d.ipynb', 'w') as f:
    nbf.write(nb, f)
print("Created DL_Training_90d.ipynb for 90-Day Horizon")
