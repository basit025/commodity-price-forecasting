...
# Cell 1: Markdown
cells.append(nbf.v4.new_markdown_cell("""# Machine Learning Training (Tree-Based Models) - 14-Day Horizon
This notebook trains 4 tree-based models across 6 commodities for a **14-Day horizon**:
1. **XGBoost**
2. **LightGBM**
3. **CatBoost**
4. **Random Forest**

Target variables are dynamically shifted by 14 days. Anomaly clipping is set to [-80%, +150%]. Overfitting protections are increased to handle overlapping targets."""))
...
nb.cells = cells
with open('ML_Training_14d.ipynb', 'w') as f:
    nbf.write(nb, f)
print("Created ML_Training_14d.ipynb for 14-Day Horizon")
