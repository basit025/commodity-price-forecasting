...
# Cell 1
cells.append(nbf.v4.new_markdown_cell("""# Deep Learning Training (Neural Networks) - 14-Day Horizon
...
nb.cells = cells
with open('DL_Training_14d.ipynb', 'w') as f:
    nbf.write(nb, f)
print("Created DL_Training_14d.ipynb for 14-Day Horizon")
