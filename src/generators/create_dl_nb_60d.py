...
# Cell 1
cells.append(nbf.v4.new_markdown_cell("""# Deep Learning Training (Neural Networks) - 60-Day Horizon
This notebook trains 5 neural architectures across 6 commodities for a **60-Day horizon**:
...
Includes dynamic 60-day target calculation, increased patience (20) for overlapping targets, and live loss curves."""))
...
BATCH_SIZE = 32
EPOCHS = 150
PATIENCE = 20 # Increased from 15 due to 60-day overlapping noise
LR = 0.001
HIDDEN_SIZE = 32
...
nb.cells = cells
with open('DL_Training_60d.ipynb', 'w') as f:
    nbf.write(nb, f)
print("Created DL_Training_60d.ipynb for 60-Day Horizon")
