...
# Cell 1
cells.append(nbf.v4.new_markdown_cell("""# Deep Learning Training (Neural Networks) - 28-Day Horizon
This notebook trains 5 neural architectures across 6 commodities for a **28-Day horizon**:
...
Includes dynamic 28-day target calculation, increased patience (20) for overlapping targets, and live loss curves."""))
...
BATCH_SIZE = 32
EPOCHS = 150
PATIENCE = 20 # Increased from 15 due to 28-day overlapping noise
LR = 0.001
HIDDEN_SIZE = 32
...
nb.cells = cells
with open('DL_Training_28d.ipynb', 'w') as f:
    nbf.write(nb, f)
print("Created DL_Training_28d.ipynb for 28-Day Horizon")
