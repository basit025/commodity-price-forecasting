...
# Cell 1: Markdown
cells.append(nbf.v4.new_markdown_cell("""# Machine Learning Training (Tree-Based Models) - 28-Day Horizon
This notebook trains 4 tree-based models across 6 commodities for a **28-Day horizon**:
1. **XGBoost**
2. **LightGBM**
3. **CatBoost**
4. **Random Forest**

Target variables are dynamically shifted by 28 days. Anomaly clipping is set to [-80%, +150%]. Overfitting protections are increased to handle overlapping targets."""))
...
nb.cells = cells
with open('ML_Training_28d.ipynb', 'w') as f:
    nbf.write(nb, f)
print("Created ML_Training_28d.ipynb for 28-Day Horizon")
