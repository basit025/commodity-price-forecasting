...
# Cell 1: Markdown
cells.append(nbf.v4.new_markdown_cell("""# Machine Learning Training (Tree-Based Models) - 120-Day Horizon
This notebook trains 4 tree-based models across 6 commodities for a **120-Day horizon**:
1. **XGBoost**
2. **LightGBM**
3. **CatBoost**
4. **Random Forest**

Target variables are dynamically shifted by 120 days. Anomaly clipping is set to [-80%, +150%]. Overfitting protections are strictly enforced to handle massive overlapping targets."""))
...
nb.cells = cells
with open('ML_Training_120d.ipynb', 'w') as f:
    nbf.write(nb, f)
print("Created ML_Training_120d.ipynb for 120-Day Horizon")
