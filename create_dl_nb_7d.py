...
# Cell 1
cells.append(nbf.v4.new_markdown_cell("""# Deep Learning Training (Neural Networks) - 7-Day Horizon
This notebook trains 5 neural architectures across 6 commodities for a **7-Day horizon**:
...
Includes dynamic 7-day target calculation, patience (20), and live loss curves."""))
...
BATCH_SIZE = 32
EPOCHS = 150
PATIENCE = 20 # maintained for consistency
LR = 0.001
HIDDEN_SIZE = 32
...
nb.cells = cells
with open('DL_Training_7d.ipynb', 'w') as f:
    nbf.write(nb, f)
print("Created DL_Training_7d.ipynb for 7-Day Horizon")
